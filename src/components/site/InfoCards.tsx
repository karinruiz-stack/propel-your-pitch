...
const FAQS = [
  ...
  { q: "How much do you invest?", a: "Our standard ticket is 600 kSEK. You receive 400 kSEK upfront as a convertible note and 200 kSEK is co-invested as equity in the next round. After the upfront investment you&apos;ll get introduced to the Propel Capital VII angel network. Many companies later raise follow-on rounds from our angel network, leveraging our ~57% follow-on rate. A Propel Capital investment is a great way to kick-start your startup journey." },
  { q: "What are you looking for?", a: "Ambitious founders building tech-driven companies with global potential from Sweden. We back exceptional teams that are ready to go all-in, and that have bold ideas with strong moats, solving a big important societal problem on a large market. You're typically 2-3 founders with an MVP or functional prototype in place, some early signals of traction, and a feasible business case. We care more about founder drive, market insight and the ability to execute than a polished pitch." },
  { q: "What are the investment terms?", a: "We invest 600 kSEK in total: 400 kSEK upfront on a standard convertible note and 200 kSEK as equity in your next priced round on the same terms as the lead. The convertible usually converts in the next round with a 30% discount and a cap. We keep terms founder-friendly, transparent and aligned with market standard for pre-seed in the Nordics.<br /><br />A Propel investment decision also means you're automatically accepted to the Sting Core program, and you will need to sign the Sting Core agreement at the same time as the Propel investment agreement. This is our way to help de-risk the investment for the Propel angels, and for you it gives you the credibility of the Sting brand and the full force of the Sting ecosystem to help you achieve success faster. The Sting Core program fee is a 2% warrant that is additional to the Propel investment." },
  { q: "Do I have to be in the Sting program?", a: "Yes, Propel Capital is Sting's investment arm and only Sting-companies can receive Propel-investments.<br /><br />There are two ways you can receive an investment from Propel Capital. You can either start with applying for a Propel-investment, and a positive investment decision then means you're also accepted into the Sting Core program. In this case you need to sign the Sting Core agreement at the same time as the investment agreement. Or you can start with applying to Sting Core or Sting Race, and if you're accepted you may be considered for a Propel Capital investment once you're in the program. In this case an investment is not guaranteed." },
