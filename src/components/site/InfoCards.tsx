...
const FAQS = [
  ...
  { q: "Who's behind Propel Capital?", a: "Propel Capital is run and managed by the team at Sting, Sweden's leading startup accelerator and ecosystem builder since 2002. Propel combines an experienced investment team with a network of 120+ angel investors — many of them successful founders, operators and executives from the Nordic tech ecosystem.<br /><br />Propel Capital I was launched in 2014. Propel Capital is currently on its seventh generation - Propel Capital VII - and has since the start made 230+ investments and engaged 120+ Propel angels. This makes Propel Capital the most active private investor in the Nordics.<br /><br />Propel Capital VII was launched in 2025 and has 27 MSEK in committed capital from 42 angel investors and Saminvest. Emanuel Andersson is the CEO of Propel Capital. Propel Capital has a board of director consisting of five Propel angels and the CEO of Sting, Karin Ruiz." },
  { q: "How does Propel Capital work?", a: "Propel Capital is a rolling pre-seed angel investment company. We invest 600 kSEK per company — 400 kSEK upfront as a convertible and 200 kSEK as equity in the next round — and introduce you to our Propel Capital angel network for follow-on capital, advice and connections. Each fund vintage (we're currently on Propel Capital VII) backs a new cohort of founders and provides curated dealflow to our Propel angels.<br /><br />You apply for a Propel investment by sending in your pitch deck here. An investment decision is paired with an intake decision to Sting Core for full force support from the Sting team and ecosystem. You need to be headquartered in Sweden to be able to receive a Propel investment." },
