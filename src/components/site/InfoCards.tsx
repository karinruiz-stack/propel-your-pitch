...
const FAQS = [
  ...
  { q: "Do I have to be in the Sting program?", a: "Yes, Propel Capital is Sting's investment arm and only Sting-companies can receive Propel-investments. <br /><br />There are two ways you can receive a Propel-investment. You can either start with applying for an investment, and a positive investment decision then means you're also automatically accepted into the Sting Core program. Or you can start with applying to Sting Core or Sting Race, and if you're accepted you may be considered for a Propel Capital investment once you're in the program; however in this case an investment is not guaranteed. " },
