...
const FAQS = [
  ...
  { q: "What should my pitch deck cover?", a: "Keep it concise (10–15 slides) and tell a clear story. We want to understand: the problem you're solving and why it matters now; your solution and what makes it hard to copy; the market size and opportunity; your business model and go-to-market; traction so far (users, revenue, pilots, LOIs); the competitive landscape and your wedge; the founding team and why you're the ones to win; and what you're raising and how you'll use it.<br /><br />Be bold and specific — we'd rather see strong opinions and a sharp narrative than a polished but vague deck. A short demo video or product screenshots help a lot." },
