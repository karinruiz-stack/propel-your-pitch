...
const FAQS = [
  ...
  { q: "Who&apos;s behind Propel Capital?", a: "Propel Capital is run by the team at Sting, Sweden&apos;s leading startup accelerator and investor since 2002. We combine an experienced investment team with a network of 100+ angel investors — many of them successful founders, operators and executives from the Nordic tech ecosystem." },
  ...
  { q: "How long does the process take?", a: "From first contact to signed term sheet, typically 4–6 weeks. We give you a clear yes or no — never a slow maybe.<br />If you get a no, you can still apply to and get accepted to Sting, and possibly be considered for an investment later." },
