...
const FAQS = [
  ...
  { q: "What are the investment terms?", a: "We invest 600 kSEK in total: 400 kSEK upfront on a standard convertible note and 200 kSEK as equity in your next priced round on the same terms as the lead. The convertible converts in the next round with a discount and a cap. We keep terms founder-friendly, transparent and aligned with market standard for pre-seed in the Nordics." },
