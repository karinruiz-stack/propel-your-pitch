const STEPS = [
  ...
  { n: "03", t: "Founder meeting", d: "We meet for a deep dive. We do reference calls, dig into the market, and validate your tech and traction together with relevant angels from our network. And finally we do a team assessment." },
  { n: "04", t: "Investment committee", d: "Your case is presented to the Propel investment committee. We give you a clear yes or no within days — never a maybe." },
  { n: "05", t: "Term sheet & onboarding", d: "We co-invest with our angels, sign a founder-friendly term sheet, and plug you into the full Sting ecosystem of coaches, partners and follow-on capital." },
];
