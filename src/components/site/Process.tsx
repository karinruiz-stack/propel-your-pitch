const STEPS = [
  ...
  { n: "06", t: "Agreements & onboarding", d: "We sign Propel Capital and Sting Core agreements, and you have the cash in your account within two weeks. We plug you into the full Sting ecosystem of coaches, partners and follow-on capital." },
];
