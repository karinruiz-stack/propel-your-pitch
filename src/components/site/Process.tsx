const STEPS = [
  ...
  { n: "04", t: "Deep dive", d: "We meet for a deep dive. We do reference calls, dig into the market, and validate your tech and traction together with relevant angels from our network. And finally we do a team assessment." },
